...
{   
    ...
    public partial class SuperAdventure : Form
    {
        ...
        private readonly System.Media.SoundPlayer PlayMusic = new System.Media.SoundPlayer();
        ...
        private void MoveTo(Location newLocation)
        {
            ...
            if(newLocation.QuestAvailableHere != null)
            {
                ...
                if (playerAlreadyHasQuest)
                {
                    ...
                    if(!playerAlreadyCompletedQuest)
                    {
                        ...
                        // If the player has all items required to complete the quest
            ...
            //Does the location has a monster
            if(newLocation.MonsterLivingHere != null)
            {
                rtbMessages.Text += "You see a " + newLocation.MonsterLivingHere.Name + Environment.NewLine;
                // Make a new monster, using the value from the standard monster in the world.Monster list
